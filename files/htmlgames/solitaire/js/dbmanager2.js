...
var StateManager = 
{
	...
	scores: [
			...
			{nick: 'Nard', score: '420', time: {h:0, m:2, s:0}, location: 'New-York', date: new Date().toUTCString()},
			{nick: 'Warp', score: '440', time: {h:0, m:1, s:45}, location: 'Zurick', date: new Date().toUTCString()},
			{nick: 'Leo', score: '400', time: {h:0, m:2, s:15}, location: 'Paris', date: new Date().toUTCString()}
		],
	...
	*/
	...
	onLoadScores: function(scores)
	{
		...
		{
			this.scoresCallback(this.scores);
		}
	},
